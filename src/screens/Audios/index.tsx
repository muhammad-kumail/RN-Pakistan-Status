...
const Audios: React.FC<any> = ({ navigation }) => {
  ...
  const formatDuration = (seconds: number) => {
    ...
    const formattedSeconds = (remainingSeconds + (seconds - totalSeconds))
      .toFixed(0)
      .padStart(2, "0");
  ...
  const NextPrevAudio = async (
    ...
    const selectedAudioIndex = AudioData.findIndex(
  ...
  const playNextAudio = async () => {
    if (
      ...
      selectedAudioIndex < AudioData.length - 1
    ) {
  ...
  const updateOptions = () => {
    ...
    TrackPlayer.updateOptions(options).then(() =>
      console.log("capabilities set")
    );
  };
    ...
    return (
      <>
        <TouchableOpacity
          ...
          onPress={() =>
            playAudio(item.audioUrl, item.title, item.audioImgColor)
          }
        >
          <View style={{ flex: 0.15 }}>
            <Image
              source={{ uri: `${Config.BASE_URL}${item.audioImg}` }}
          ...
          <View style={{ flex: 0.7, zIndex: 0 }}>
            <Text
              ...
              style={{
                color:
                  isFocused && selectedAudio !== null ? "#B036C1" : "white",
                fontSize: wp(4),
                marginBottom: wp(0.7),
              }}
            >
        ...
        {menuVisibleList[index] && openMenuIndex === index && (
          ...
          >
            <View>
              <TouchableOpacity
                onPress={() =>
                  shareAudio(`${Config.BASE_URL}${item?.audioUrl}`)
                }
                style={{ flexDirection: "row", alignItems: "center" }}
              >
                <Image
                  source={images.shareBlack}
                  style={{ height: wp(3), width: wp(3), resizeMode: "contain" }}
                />
                <Text
                  style={{
                    color: "black",
            ...
            <View>
              <TouchableOpacity
                onPress={() =>
                  downloadAudio(`${Config.BASE_URL}${item?.audioUrl}`)
                }
                style={{ flexDirection: "row", alignItems: "center" }}
              >
                <Image
                  source={images.downloadBlack}
                  style={{ height: wp(3), width: wp(3), resizeMode: "contain" }}
                />
                <Text
                  style={{
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
              ...
              {selectedAudio === null ? null : (
                ...
                >
                  <View
                    style={[
                      style.container,
                      { backgroundColor: selectedAudio.audioImgColor },
                    ]}
                  >
                    <View style={{ flex: 0.1 }}>
                      <Image
                        source={{
                          uri: `${Config.BASE_URL}${selectedAudio.audioImg}`,
                        }}
                    ...
                    <View style={{ flex: 0.1, alignItems: "flex-end" }}>
                      <TouchableOpacity onPress={handlePlayPause}>
                        <Image
                          source={isPlaying ? images.pausebtn : images.playBtn}
        ...
        >
          ...
          <View style={styles.modalTop}>
            ...
            <View style={styles.modalTopOption}>
              ...
              >
                <Image
                  source={images.verticalDotsWhite}
                  style={{ height: wp(4), width: wp(4), resizeMode: "contain" }}
                />
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.modalCenter}>
            <Image
              source={{ uri: `${Config.BASE_URL}${selectedAudio?.audioImg}` }}
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <TouchableOpacity onPress={handleRepeat}>
                  <Image
                    ...
                    style={styles.modalBottomSideIcons}
                  />
                </TouchableOpacity>
                <TouchableOpacity onPress={playPreviousAudio}>
                  <Image
                    source={images.previousPlay}
                    style={styles.modalNextPrev}
                  />
                </TouchableOpacity>
                <TouchableOpacity onPress={handlePlayPause}>
                  <Image
                    source={isPlaying ? images.pauseWhite : images.playWhite}
                    style={styles.modalPlaybtn}
                  />
                </TouchableOpacity>
                <TouchableOpacity onPress={playNextAudio}>
                  <Image
                    source={images.nextPlay}
                    style={styles.modalNextPrev}
                  />
                </TouchableOpacity>
      ...
      >
        <View
          style={{ flexDirection: "column", marginHorizontal: wp(7), flex: 1 }}
        >
          <View
          ...
          >
            ...
            <View style={{ flex: 0.75 }}>
              ...
              <Text style={{ color: "grey", fontSize: wp(2) }}>
                {selectedAudio?.author}
              </Text>
            </View>
          </View>
          <View style={{ flex: 0.5, justifyContent: "center" }}>
            <View style={{ flex: 0.5 }}>
              <TouchableOpacity
                onPress={() =>
                  shareAudio(`${Config.BASE_URL}${selectedAudio?.audioUrl}`)
                }
                style={{ flexDirection: "row", alignItems: "center" }}
              >
                <Image
                  source={images.shareWhite}
                  style={{ height: wp(4), width: wp(4), resizeMode: "contain" }}
                />
                <Text
                  style={{
            ...
            <View style={{ flex: 0.5 }}>
              <TouchableOpacity
                onPress={() =>
                  downloadAudio(`${Config.BASE_URL}${selectedAudio?.audioUrl}`)
                }
                style={{ flexDirection: "row", alignItems: "center" }}
              >
                <Image
                  source={images.downloadWhite}
                  style={{ height: wp(4), width: wp(4), resizeMode: "contain" }}
                />
                <Text
                  style={{
